...
print( x.flat )         # [ 1 2 3 4 7 0 ] # <numpy.flatiter object at 0x000001F3C7A45180>
for element in x.flat :
    print( element )

# [3] 배열의 데이터 타입 
# bit 란 ? 0 또는 1 으로 이루어진 2진수 
# 8bit 란 ? 0 또는 1 으로 이루어진 2진수가 8개 모이면 -> 1byte 
# 즉] bit 많을수록 더 많은 자료 표현할 수 있다.
